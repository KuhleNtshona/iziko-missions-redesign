  ...
  return (
    <main>
      <header className={`site-header ${scrolled ? 'is-scrolled' : ''}`}>
        <a className="brand brand-3d" href="#home" aria-label="Iziko Missions home"><span className="brand-3d-crop"><img src="./iziko-emblem-3d.png" alt="" aria-hidden="true" /></span><span>IZIKO <b>MISSIONS</b></span></a>
      ...
      <footer><div className="footer-top"><a className="brand footer-brand brand-3d" href="#home"><span className="brand-3d-crop"><img src="./iziko-emblem-3d.png" alt="" aria-hidden="true" /></span><span>IZIKO <b>MISSIONS</b></span></a><p>Christ proclaimed. Leaders equipped. Churches planted.</p><div className="mailing"><a href="mailto:info@izikomission.org">info@izikomission.org</a><address><b>Iziko Missions South Africa</b><br/>539 W. Commerce St. #5455<br/>Dallas, TX 75208</address><small>Make checks payable to Iziko Missions South Africa.</small></div></div><div className="nonprofit">Iziko Missions South Africa is a registered 501(c)(3) nonprofit organization. Federal Tax ID: 39-3246865.</div><div className="footer-bottom"><span>© 2026 Iziko Missions</span><span>Cape Town · South Africa</span><div><a href="./about/">About</a><a href="./team/">Meet the Team</a><a href="https://www.zeffy.com/en-US/donation-form/support-the-nogadas" target="_blank" rel="noopener noreferrer">Give</a><a href="#contact">Contact</a></div></div></footer>
    </main>
  );
}
